...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PaceLab — Prescrição de treinos de corrida" },
      { name: "description", content: "Plataforma profissional para professores de corrida prescreverem treinos personalizados." },
      { property: "og:title", content: "PaceLab — Prescrição de treinos de corrida" },
      { name: "twitter:title", content: "PaceLab — Prescrição de treinos de corrida" },
      { property: "og:description", content: "Plataforma profissional para professores de corrida prescreverem treinos personalizados." },
      { name: "twitter:description", content: "Plataforma profissional para professores de corrida prescreverem treinos personalizados." },
