...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "https://pub-87cb7b9bcf7a4d8097c43101ac0213ea.r2.dev/8020pace-logo.png" },
      { rel: "apple-touch-icon", href: "https://pub-87cb7b9bcf7a4d8097c43101ac0213ea.r2.dev/8020pace-logo.png" },
