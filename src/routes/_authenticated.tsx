...
import { GuardRolesCtx } from "@/lib/use-role";
...
function Layout() {
  ...
  return (
    <GuardRolesCtx.Provider value={{
      isAdmin: guardQ.data?.isAdmin ?? false,
      isCoach: guardQ.data?.isCoach ?? false,
      isRunner: guardQ.data?.isRunner ?? false,
    }}>
      <SidebarProvider
        open={sidebarOpen}
